...
export const commandCatalog: CatalogCommand[] = [
  ...
  { catalog_key: "system.reboot", category: "Sistema", name: "Reiniciar sistema", description: "Solicita reinicio del target. Requiere privilegios sudo configurados en el target.", command_template: "sudo /sbin/reboot", risk_level: "high", requires_approval: true, allowed_roles: ["admin"], enabled: true, destructive: true },
  { catalog_key: "services.restart.nginx", category: "Servicios", name: "Reiniciar nginx", description: "Reinicia nginx mediante systemd.", command_template: "sudo systemctl restart nginx", risk_level: "high", requires_approval: true, allowed_roles: ["admin"], enabled: true, destructive: true },
  { catalog_key: "services.restart.docker", category: "Servicios", name: "Reiniciar Docker", description: "Reinicia el servicio Docker mediante systemd.", command_template: "sudo systemctl restart docker", risk_level: "high", requires_approval: true, allowed_roles: ["admin"], enabled: true, destructive: true },
];
